...
export const Runner: FC = () => {
  ...
  const progressVisible = isRunning || canceledRun;
  const activeTab = !progressVisible && selectedTab === 'progress' ? 'test-results' : selectedTab;
    ...
    <>
      ...
      <Panel id="pane-two" className="pane-two theme--pane">
        ...
        >
          ...
          {progressVisible && (
            <TabPanel className="flex w-full flex-1 flex-col overflow-y-auto" id="progress">
